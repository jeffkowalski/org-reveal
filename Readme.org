...
*** Single Video Background
    :PROPERTIES:
    :reveal_background_video: http://clips.vorwaerts-gmbh.de/big_buck_bunny.mp4
    :END:

    Set property =reveal_background_video= to an URL of background video.
#+BEGIN_SRC org
,*** Single Video Background
    :PROPERTIES:
    :reveal_background_video: http://clips.vorwaerts-gmbh.de/big_buck_bunny.mp4
...
*** IFrame Background
    ...
    Set property =reveal_background_iframe= to a URL to embed the web
    page as a background.
    Note that the page won't be interactive.
#+BEGIN_SRC org
,*** Single Image Background
    :PROPERTIES:
    :reveal_background_iframe: https://slides.com
